...
<body>
  ...
  <div id="bodybox">
    <div id="content">
      ...
      <p>Although there are many definitions, clinical trials are generally considered to be biomedical or health-related research studies in human beings that follow a pre-defined protocol. Interventional studies are those in which the research subjects are assigned by the investigator to a treatment or other intervention, and their outcomes are measured. Observational studies are those in which individuals are observed and their outcomes are measured by the investigators. <br />
      </p>
      <p>&nbsp;</p>

      <h3>The Phases of Studies</h3>
